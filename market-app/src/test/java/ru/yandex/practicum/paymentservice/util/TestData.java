...
import ru.yandex.practicum.paymentservice.dto.OrderItemDto;
...
public final class TestData {
  ...
  public static CartItem cartItem() {
    return cartItem(BigDecimal.valueOf(100), 1);
  }

  public static CartItem cartItem(BigDecimal price, Integer count) {
  ...
  public static OrderDto orderDto() {
    return new OrderDto(1L, List.of(orderItemDto()), BigDecimal.valueOf(100));
  }
}
